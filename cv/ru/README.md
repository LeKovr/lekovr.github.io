...
* команду, сопровождающую бизнес, привносящий в этот мир что-то материальное и(или) полезное
* команду, которая среди своих задач смогла выделить подсистемы, достойные публикации
* команду, готовую к распределенной работе
* проекты, использующие linux

## Что не ищу

* проекты, связанные со спамом и прочими темами, которыми не получится публично гордиться
* проекты по распилу денег инвесторов
