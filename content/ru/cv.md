...
### Разработчик golang {#inno}

[ГК Иннотех](https://inno.tech)

#### Октябрь 2021 — настоящее время. Руководитель группы разработки

* сопровождение существующих сервисов
* менторинг команды go-разработчиков
* вывод новых сервисов и версий сервисов в прод
* участие в митингах по планированию и координации работ
