...
## Разработчик..тимлид проектов, использующих
...
Проект с профессиональными коллегами и вменяемыми менеджерами, команду, которая
...
* проекты по распилу денег инвесторов, "NoSQL" и "blockchain"
