...
Проекты, связанные со спамом, азартными играми, NoSQL, BTC и подобными темами, которыми мне не получится публично гордиться.
...
* проектирование и реализация прототипов перспективной архитектуры проекта ([RPC-sample](https://github.com/TenderPro/rpc-sample-app), [rpckit](https://github.com/TenderPro/rpckit))
* проектирование и реализация JSON <-> SQL proxy для тендерной системы ([dbrpc](https://github.com/LeKovr/dbrpc))
* контейнеризация legacy-подсистем ([dockerfile-modperl](https://github.com/TenderPro/dockerfile-modperl))
* CI/CD на базе docker ([dcape](https://github.com/dopos/dcape))
...
* 2008, JQ. Система гарантированной тарификации на основе очереди задач (perl, PostgreSQL/plpgsql)
* 2007, [JAST](https://sourceforge.net/projects/overssi/files/overssi/0.45/). Ядро веб-интерфейса b2b проекта (mod_perl, PostgreSQL/plpgsql)
...
* 2006, [OverSSIDB](http://overssi.sourceforge.net/). БД управления web-интерфейсом (mod_perl, PostgreSQL/plpgsql)
