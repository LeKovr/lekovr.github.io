...
* Корпоративная интернет-среда (Linux), 2000.
* Система публикации прайс-листов (Perl, PostgreSQL), 1999.
* Система учета движения товаров и услуг для сервисной фирмы (Delphi, Crystal Reports, MS Access), 1998.
* Клиент/серверная версия системы анализа баланса банка (Oracle,PL/SQL, Delphi, Sybase Power Designer), 1997.
* Система анализа баланса банка (PAL), 1996.
