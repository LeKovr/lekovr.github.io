...
* признательность за первое и осознание второго вывело команду на публикацию функционала общего назначения и проведение доработок через, скажем, "github issues"
