...
Программист с опытом работы 2н0+ лет. Специализируюсь на бэкенде, но имею опыт в администрировании linux и во фронтенде. Не ограничиваюсь кодированием по ТЗ и стараюсь делать все возможное для успеха проекта в целом.

## Имею опыт, [opensource](https://github.com/LeKovr) и планирую развиваться в направлениях
