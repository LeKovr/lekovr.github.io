...
Участвую в проектах, которые требуют от нескольких месяцев и полное погружение. Для дедлайнов могу находить до 16ч в сутки.

В проектах занимал роли архитектора, ключевого разработчика, руководителя команды, единственного разработчика

В свободное время и в рамках проектов [участвую в opensource](https://github.com/LeKovr).

## Ключевые навыки

* SQL (PostgreSQL: 1999 - н.в., Oracle: 1997 - 1999)
* golang (2015 - н.в.)
...
В идеале, этот процесс выглядел бы так:
...
* 2001, Сайты публикации прайс-листов для региональной газеты (www.price.kuban.su) и фармацевтической компании (www.farma.ru) (mod_perl, HTML::Mason, PostgreSQL)
