...
* **удаленка** - я работаю дистанционно с 2006г, для меня готовность получать нужный результат от сотрудника на удаленке - одно из ключевых требований к нанимателю
...
* HR или кто-то из команды где-то ищет гоферов и пишет им примерно так: "мы готовы платить до ХХ в час, вот список issues. Если Вас заинтересует и Ваш MR примем - готовы обсудить ставку"

Возможно ли такое вообще и, если - да, то - где? когда? ;-)
...
* бэкенд тендерной системы (perl, plpgsql), 2010г
* биллинг оператора фиксированной связи (perl, plpgsql, C), 2003г
* сайты публикации прайс-листов для региональной газеты и фармацевтической компании (perl, plpgsql), 2001г
...
#### Май - Октябрь 2021. Старший разработчик
